...
class Tile(pygame.sprite.Sprite): # Inherit Sprite method of sprite class (build-in class in pygame to manage spirtes)
    def __init__(self, pos, surf, groups):
        ...
        self.hitbox = self.rect.inflate(0,0) # hitbox(x,y) is another rect of the same size of the precedent, that can be modified to get 3D illusion in collision with other tiles
