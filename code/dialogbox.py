...
class MyWindow:
    ...
    def draw(self, screen):
        ...
        pygame.draw.rect(screen, (255, 255, 255), (self.x - 10, self.y - 10, self.width + 20, self.height + 20))
        rect = pygame.draw.rect(screen, (0, 0, 0), (self.x, self.y, self.width, self.height))  #assign the draw rectangle to a var
        screen.blit(self.text_surface, (rect.x + 10, rect.y + 10))  #blit the text onto the screen in the rect position
