...
class testi:
    ...
    def dialogues(self, name, dialgue_printed, speech):  # methods with all the text interaction of the game
        
        if name: #if there is a name as entry from the colliderect function in Level

            #Librarian Dialogues
            if name == 'Librarian' and not dialgue_printed and not all(self.Kings_interact): #if you have not  talk with the four magic beasts yet
                ...
                dialgue_printed= True #says that something has been printed (Then in Level there it takes false, useful to stop the for loop at the first occurences)
                self.Librarian1 = True
                return speech
            elif name == 'Librarian' and not dialgue_printed and all(self.Kings_interact) and not all(self.mission_check): #if you have already talk with the four magic beasts
                ...
                dialgue_printed = True
                self.Librarian2 = True
                return speech
            elif name == 'Librarian' and not dialgue_printed and self.Genius == True and all(self.mission_check): #if you have completed all the mission
            ...
            # Calsifer Dialogues
            if name == 'Calsifer'and not dialgue_printed:
                speech = "CALCIFER: Brrrn*.. Brn.. Brrrrrn*.. 'Damn this fire is hot!'"
                dialgue_printed= True
                return speech

            # Genius Dialogues
            if name == 'Table_up' and not dialgue_printed and self.Librarian2 == False: #table_up is the new genius
                speech = "This statue is kinda ugly! But I feel like it releases a mysterous aura.." 
                dialgue_printed = True
                return speech
            elif name == 'Table_up' and not dialgue_printed and self.Librarian2 == True:
                speech = "THE FLOOR SHAKES! THREE BOOK APPEAR ON THE FLOOR (and a nasty gossip magazine also..)"
                dialgue_printed = True
                self.Genius = True
                self.Genius_count += 1
                return speech
            elif name == 'Table_up' and not dialgue_printed and self.Librarian2 == True and self.Genius_count == 1:
                speech = "GENIUS: Bro I've already gave you the books, just grab them and finish the quests.."
                dialgue_printed = True
                return speech
                
            #Squid Dialogues
            if name == 'King_squid' and not dialgue_printed and self.Librarian1 == False: #if not interacted with Librarian yet
                speech = "KING SQUID: ° ° BLUB BLUB BLUB ° ° BLUB ° ° BLUB BLUB ° ° BLUB BLUB BLUB ° ° BLUB BLUB BLUB ° °"
                dialgue_printed = True
                return speech
            elif name == 'King_squid'and not dialgue_printed and self.Librarian1 == True and self.Genius == False: #if already interacted with Librarian
                ...
                return speech
            elif name == 'King_squid'and not dialgue_printed and self.Genius == True: #if you've get the books
            ...
            #Raccoon Dialogues
            if name == 'King_raccoon' and not dialgue_printed and self.Librarian1 == False:
                speech ="KING RACCOON: Grrr.. I'm Hungry! Who's there? I'm going to eat you!"
                dialgue_printed = True
                return speech
            elif name == 'King_raccoon' and not dialgue_printed and self.Librarian1 == True and self.Genius == False:
                ...
                return speech
            elif name == 'King_raccoon' and not dialgue_printed and self.Genius == True:
            ...
            #Bamboo Dialogue
            if name == 'King_bamboo' and not dialgue_printed and self.Librarian1 == False:
                speech = "KING BAMBOO: Frù.. Frù.. ~chasse~ oi! Frù.. Frù.. ~twist~ oi oi!"
                dialgue_printed = True
                return speech
            elif name == 'King_bamboo' and not dialgue_printed and self.Librarian1 == True and self.Genius == False:
                ...
                return speech
            elif name == 'King_bamboo' and not dialgue_printed and  self.Genius == True:
            ...
            #Skeleton Dialogue
            if name == 'King_skeleton' or "The deadman's letter" and not dialgue_printed and  self.Librarian1 == False:
                speech = "NORMAL SKELETON: Sigh* sigh*.. i feel so lonely.."
                dialgue_printed = True
                return speech
            elif name == 'King_skeleton' or "The deadman's letter" and not dialgue_printed and  self.Librarian1 == True and self.Genius == False:
                ...
                return speech
            elif name == 'King_skeleton' or "The deadman's letter" and not dialgue_printed and self.Librarian1 == True and self.Librarian2 == True and self.Genius == True:
