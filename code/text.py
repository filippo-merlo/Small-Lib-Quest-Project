    ...
    def dialogues(self, name, diag_print, speech):  # methods with all the text interaction of the game
        ...
        if name: #if there is a name as entry from the colliderect function in Level
            ...
            if name == 'Librarian' and not diag_print and self.King_raccoon == False and self.King_squid == False and self.King_skeleton == False and self.King_bamboo == False: #if you have not  talk with the four magic beasts yet
                speech = "LIBRARIAN: You!!! I was waiting for you! You are the hero the Human King sent! The four King of the beasts of this world are mad, you have to help us! "
            ...
            if name == 'King_bamboo' and not diag_print and self.Librarian1 == False:
                ...
                speech = "KING BAMBOO: Look! All my children are having so much fun dancing, but my back hurt so much, I need a book to learn how to strech!"
                diag_print = True
            ...
            if name == 'King_skeleton' or "The deadman's letter" and not diag_print and  self.Librarian1 == False:
                ...
                speech = "NORMAL SKELETON: Hey! I'm not the King! He has disappeard this morning actually.. I'm here alone now.. What should i do..? He left this letter though! But is written in spanish and I cannod read it.. I could use a vocabulary.. I guess.."
                diag_print = True
                ...
                speech = "NORMAL SKELETON: Oh thank you, he just said he needed a holiday.. So he flew to Ibiza.. Why didn't he invite me? sigh.."
                diag_print = True
