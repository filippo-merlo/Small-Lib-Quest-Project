class testi:
    ...
    def dialogues (self): #funzione con tutte le possibilità del gioco e le linee di testo [fare diagramma]
#Dialogo squirrel        
...
#Dialogo skeleton
        if self.skeleton == False and self.who_is_talking == 3: 
            ...
            self.missions_check += 1
            return "SKELETON: Oh thank you, he just said he needed a holiday"
#Dialogo Bambu
